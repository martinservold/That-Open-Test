...
const viewerContainer = document.getElementById("sharepoint-viewer-MEE-TEST1") as HTMLDivElement
...
window.addEventListener("MEE-IFC-EVENT", async(event:any)=>{
  const {name, payload} = event.detail;
  if(name == "MEE-IFC-EVENT"){
